...
type SMF struct {
	...
	Config *SMFConfig `json:"config,omitempty" yaml:"config,omitempty" mapstructure:"config,omitempty"`

	// ContainerPorts corresponds to the JSON schema field "containerPorts".
	ContainerPorts *SMFContainerPorts `json:"containerPorts,omitempty" yaml:"containerPorts,omitempty" mapstructure:"containerPorts,omitempty"`

	// ContainerSecurityContext corresponds to the JSON schema field
	// "containerSecurityContext".
	ContainerSecurityContext *SMFContainerSecurityContext `json:"containerSecurityContext,omitempty" yaml:"containerSecurityContext,omitempty" mapstructure:"containerSecurityContext,omitempty"`
	...
	Global *SMFGlobal `json:"global,omitempty" yaml:"global,omitempty" mapstructure:"global,omitempty"`
	...
	Image *SMFImage `json:"image,omitempty" yaml:"image,omitempty" mapstructure:"image,omitempty"`
	...
	LivenessProbe *SMFLivenessProbe `json:"livenessProbe,omitempty" yaml:"livenessProbe,omitempty" mapstructure:"livenessProbe,omitempty"`

	// Metrics corresponds to the JSON schema field "metrics".
	Metrics *SMFMetrics `json:"metrics,omitempty" yaml:"metrics,omitempty" mapstructure:"metrics,omitempty"`
	...
	NodeAffinityPreset *SMFNodeAffinityPreset `json:"nodeAffinityPreset,omitempty" yaml:"nodeAffinityPreset,omitempty" mapstructure:"nodeAffinityPreset,omitempty"`
	...
	PodSecurityContext *SMFPodSecurityContext `json:"podSecurityContext,omitempty" yaml:"podSecurityContext,omitempty" mapstructure:"podSecurityContext,omitempty"`
	...
	ReadinessProbe *SMFReadinessProbe `json:"readinessProbe,omitempty" yaml:"readinessProbe,omitempty" mapstructure:"readinessProbe,omitempty"`
	...
	Resources *SMFResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
	...
	ServiceAccount *SMFServiceAccount `json:"serviceAccount,omitempty" yaml:"serviceAccount,omitempty" mapstructure:"serviceAccount,omitempty"`

	// Services corresponds to the JSON schema field "services".
	Services *SMFServices `json:"services,omitempty" yaml:"services,omitempty" mapstructure:"services,omitempty"`
	...
	StartupProbe *SMFStartupProbe `json:"startupProbe,omitempty" yaml:"startupProbe,omitempty" mapstructure:"startupProbe,omitempty"`
	...
	UpdateStrategy *SMFUpdateStrategy `json:"updateStrategy,omitempty" yaml:"updateStrategy,omitempty" mapstructure:"updateStrategy,omitempty"`
}
...
type SMFConfig struct {
	...
	// DnsList corresponds to the JSON schema field "dnsList".
	DnsList []string `json:"dnsList,omitempty" yaml:"dnsList,omitempty" mapstructure:"dnsList,omitempty"`
	...
	Mtu *int `json:"mtu,omitempty" yaml:"mtu,omitempty" mapstructure:"mtu,omitempty"`

	// Pcrf corresponds to the JSON schema field "pcrf".
	Pcrf *SMFConfigPcrf `json:"pcrf,omitempty" yaml:"pcrf,omitempty" mapstructure:"pcrf,omitempty"`
	...
	Upf *SMFConfigUpf `json:"upf,omitempty" yaml:"upf,omitempty" mapstructure:"upf,omitempty"`
}

type SMFConfigPcrf struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`

	// Frdi corresponds to the JSON schema field "frdi".
	Frdi *SMFConfigPcrfFrdi `json:"frdi,omitempty" yaml:"frdi,omitempty" mapstructure:"frdi,omitempty"`
}

type SMFConfigPcrfFrdi struct {
...
type SMFConfigSbi struct {
	// Client corresponds to the JSON schema field "client".
	Client *SMFConfigSbiClient `json:"client,omitempty" yaml:"client,omitempty" mapstructure:"client,omitempty"`
...
type SMFConfigSbiClient struct {
	// Nrf corresponds to the JSON schema field "nrf".
	Nrf *SMFConfigSbiClientNrf `json:"nrf,omitempty" yaml:"nrf,omitempty" mapstructure:"nrf,omitempty"`

	// Scp corresponds to the JSON schema field "scp".
	Scp *SMFConfigSbiClientScp `json:"scp,omitempty" yaml:"scp,omitempty" mapstructure:"scp,omitempty"`
}

type SMFConfigSbiClientNrf struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type SMFConfigSbiClientScp struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type SMFConfigSubnetListElem struct {
...
type SMFConfigUpf struct {
	// Pfcp corresponds to the JSON schema field "pfcp".
	Pfcp *SMFConfigUpfPfcp `json:"pfcp,omitempty" yaml:"pfcp,omitempty" mapstructure:"pfcp,omitempty"`
}

type SMFConfigUpfPfcp struct {
	// Hostname corresponds to the JSON schema field "hostname".
	Hostname *string `json:"hostname,omitempty" yaml:"hostname,omitempty" mapstructure:"hostname,omitempty"`
}

type SMFContainerPorts struct {
	// Frdi corresponds to the JSON schema field "frdi".
	Frdi *int `json:"frdi,omitempty" yaml:"frdi,omitempty" mapstructure:"frdi,omitempty"`

	// Gtpc corresponds to the JSON schema field "gtpc".
	Gtpc *int `json:"gtpc,omitempty" yaml:"gtpc,omitempty" mapstructure:"gtpc,omitempty"`
...
type SMFContainerSecurityContext struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type SMFMetrics struct {
	...
	ServiceMonitor *SMFMetricsServiceMonitor `json:"serviceMonitor,omitempty" yaml:"serviceMonitor,omitempty" mapstructure:"serviceMonitor,omitempty"`

	// ServiceScrape corresponds to the JSON schema field "serviceScrape".
	ServiceScrape *SMFMetricsServiceScrape `json:"serviceScrape,omitempty" yaml:"serviceScrape,omitempty" mapstructure:"serviceScrape,omitempty"`
}

type SMFMetricsServiceMonitor struct {
...
type SMFMetricsServiceScrape struct {
	// AdditionalLabels corresponds to the JSON schema field "additionalLabels".
	AdditionalLabels map[string]interface{} `json:"additionalLabels,omitempty" yaml:"additionalLabels,omitempty" mapstructure:"additionalLabels,omitempty"`
...
type SMFNodeAffinityPreset struct {
...
type SMFPodSecurityContext struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type SMFServices struct {
	// Frdi corresponds to the JSON schema field "frdi".
	Frdi *SMFServicesFrdi `json:"frdi,omitempty" yaml:"frdi,omitempty" mapstructure:"frdi,omitempty"`

	// Gtpc corresponds to the JSON schema field "gtpc".
	Gtpc *SMFServicesGtpc `json:"gtpc,omitempty" yaml:"gtpc,omitempty" mapstructure:"gtpc,omitempty"`

	// Gtpu corresponds to the JSON schema field "gtpu".
	Gtpu *SMFServicesGtpu `json:"gtpu,omitempty" yaml:"gtpu,omitempty" mapstructure:"gtpu,omitempty"`

	// Metrics corresponds to the JSON schema field "metrics".
	Metrics *SMFServicesMetrics `json:"metrics,omitempty" yaml:"metrics,omitempty" mapstructure:"metrics,omitempty"`

	// Pfcp corresponds to the JSON schema field "pfcp".
	Pfcp *SMFServicesPfcp `json:"pfcp,omitempty" yaml:"pfcp,omitempty" mapstructure:"pfcp,omitempty"`

	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *SMFServicesSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SMFServicesFrdi struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	NodePorts *SMFServicesFrdiNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesFrdiPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesFrdiNodePorts struct {
	// Frdi corresponds to the JSON schema field "frdi".
	Frdi *string `json:"frdi,omitempty" yaml:"frdi,omitempty" mapstructure:"frdi,omitempty"`
}

type SMFServicesFrdiPorts struct {
	// Frdi corresponds to the JSON schema field "frdi".
	Frdi *int `json:"frdi,omitempty" yaml:"frdi,omitempty" mapstructure:"frdi,omitempty"`
}

type SMFServicesGtpc struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	// NodePorts corresponds to the JSON schema field "nodePorts".
	NodePorts *SMFServicesGtpcNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesGtpcPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesGtpcNodePorts struct {
	// Gtpc corresponds to the JSON schema field "gtpc".
	Gtpc *string `json:"gtpc,omitempty" yaml:"gtpc,omitempty" mapstructure:"gtpc,omitempty"`
}

type SMFServicesGtpcPorts struct {
	// Gtpc corresponds to the JSON schema field "gtpc".
	Gtpc *int `json:"gtpc,omitempty" yaml:"gtpc,omitempty" mapstructure:"gtpc,omitempty"`
}

type SMFServicesGtpu struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	// NodePorts corresponds to the JSON schema field "nodePorts".
	NodePorts *SMFServicesGtpuNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesGtpuPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesGtpuNodePorts struct {
	// Gtpu corresponds to the JSON schema field "gtpu".
	Gtpu *string `json:"gtpu,omitempty" yaml:"gtpu,omitempty" mapstructure:"gtpu,omitempty"`
}

type SMFServicesGtpuPorts struct {
	// Gtpu corresponds to the JSON schema field "gtpu".
	Gtpu *int `json:"gtpu,omitempty" yaml:"gtpu,omitempty" mapstructure:"gtpu,omitempty"`
}

type SMFServicesMetrics struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations *SMFServicesMetricsAnnotations `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	// NodePorts corresponds to the JSON schema field "nodePorts".
	NodePorts *SMFServicesMetricsNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesMetricsPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesMetricsAnnotations struct {
...
type SMFServicesMetricsNodePorts struct {
	// Metrics corresponds to the JSON schema field "metrics".
	Metrics *string `json:"metrics,omitempty" yaml:"metrics,omitempty" mapstructure:"metrics,omitempty"`
}

type SMFServicesMetricsPorts struct {
	// Metrics corresponds to the JSON schema field "metrics".
	Metrics *int `json:"metrics,omitempty" yaml:"metrics,omitempty" mapstructure:"metrics,omitempty"`
}

type SMFServicesPfcp struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	// NodePorts corresponds to the JSON schema field "nodePorts".
	NodePorts *SMFServicesPfcpNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesPfcpPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesPfcpNodePorts struct {
	// Pfcp corresponds to the JSON schema field "pfcp".
	Pfcp *string `json:"pfcp,omitempty" yaml:"pfcp,omitempty" mapstructure:"pfcp,omitempty"`
}

type SMFServicesPfcpPorts struct {
	// Pfcp corresponds to the JSON schema field "pfcp".
	Pfcp *int `json:"pfcp,omitempty" yaml:"pfcp,omitempty" mapstructure:"pfcp,omitempty"`
}

type SMFServicesSbi struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	// NodePorts corresponds to the JSON schema field "nodePorts".
	NodePorts *SMFServicesSbiNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SMFServicesSbiPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SMFServicesSbiNodePorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *string `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SMFServicesSbiPorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *int `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SMFStartupProbe struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
