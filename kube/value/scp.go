...
type SCP struct {
	...
	Config *SCPConfig `json:"config,omitempty" yaml:"config,omitempty" mapstructure:"config,omitempty"`

	// ContainerPorts corresponds to the JSON schema field "containerPorts".
	ContainerPorts *SCPContainerPorts `json:"containerPorts,omitempty" yaml:"containerPorts,omitempty" mapstructure:"containerPorts,omitempty"`

	// ContainerSecurityContext corresponds to the JSON schema field
	// "containerSecurityContext".
	ContainerSecurityContext *SCPContainerSecurityContext `json:"containerSecurityContext,omitempty" yaml:"containerSecurityContext,omitempty" mapstructure:"containerSecurityContext,omitempty"`
	...
	Global *SCPGlobal `json:"global,omitempty" yaml:"global,omitempty" mapstructure:"global,omitempty"`
	...
	Image *SCPImage `json:"image,omitempty" yaml:"image,omitempty" mapstructure:"image,omitempty"`
	...
	LivenessProbe *SCPLivenessProbe `json:"livenessProbe,omitempty" yaml:"livenessProbe,omitempty" mapstructure:"livenessProbe,omitempty"`

	// Mongodb corresponds to the JSON schema field "mongodb".
	Mongodb *SCPMongodb `json:"mongodb,omitempty" yaml:"mongodb,omitempty" mapstructure:"mongodb,omitempty"`
	...
	NodeAffinityPreset *SCPNodeAffinityPreset `json:"nodeAffinityPreset,omitempty" yaml:"nodeAffinityPreset,omitempty" mapstructure:"nodeAffinityPreset,omitempty"`
	...
	PodSecurityContext *SCPPodSecurityContext `json:"podSecurityContext,omitempty" yaml:"podSecurityContext,omitempty" mapstructure:"podSecurityContext,omitempty"`
	...
	ReadinessProbe *SCPReadinessProbe `json:"readinessProbe,omitempty" yaml:"readinessProbe,omitempty" mapstructure:"readinessProbe,omitempty"`
	...
	Resources *SCPResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
	...
	ServiceAccount *SCPServiceAccount `json:"serviceAccount,omitempty" yaml:"serviceAccount,omitempty" mapstructure:"serviceAccount,omitempty"`

	// Services corresponds to the JSON schema field "services".
	Services *SCPServices `json:"services,omitempty" yaml:"services,omitempty" mapstructure:"services,omitempty"`
	...
	StartupProbe *SCPStartupProbe `json:"startupProbe,omitempty" yaml:"startupProbe,omitempty" mapstructure:"startupProbe,omitempty"`
	...
	UpdateStrategy *SCPUpdateStrategy `json:"updateStrategy,omitempty" yaml:"updateStrategy,omitempty" mapstructure:"updateStrategy,omitempty"`
}
...
type SCPConfig struct {
	...
	Sbi *SCPConfigSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SCPConfigSbi struct {
	// Client corresponds to the JSON schema field "client".
	Client *SCPConfigSbiClient `json:"client,omitempty" yaml:"client,omitempty" mapstructure:"client,omitempty"`
...
type SCPConfigSbiClient struct {
	// Nrf corresponds to the JSON schema field "nrf".
	Nrf *SCPConfigSbiClientNrf `json:"nrf,omitempty" yaml:"nrf,omitempty" mapstructure:"nrf,omitempty"`
}

type SCPConfigSbiClientNrf struct {
...
func (j *SCPConfigSbi) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	type Plain SCPConfigSbi
	var plain Plain
	...
	*j = SCPConfigSbi(plain)
	return nil
}

// UnmarshalYAML implements yaml.Unmarshaler.
func (j *SCPConfigSbi) UnmarshalYAML(value *yaml.Node) error {
	var raw map[string]interface{}
...
type SCPMongodb struct {
	// Auth corresponds to the JSON schema field "auth".
	Auth *SCPMongodbAuth `json:"auth,omitempty" yaml:"auth,omitempty" mapstructure:"auth,omitempty"`

	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
}

type SCPMongodbAuth struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
}

type SCPNodeAffinityPreset struct {
...
type SCPPodSecurityContext struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type SCPServices struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *SCPServicesSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SCPServicesSbi struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	NodePorts *SCPServicesSbiNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *SCPServicesSbiPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type SCPServicesSbiNodePorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *string `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SCPServicesSbiPorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *int `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type SCPStartupProbe struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
