...
type UDR struct {
	...
	Config *UDRConfig `json:"config,omitempty" yaml:"config,omitempty" mapstructure:"config,omitempty"`

	// ContainerPorts corresponds to the JSON schema field "containerPorts".
	ContainerPorts *UDRContainerPorts `json:"containerPorts,omitempty" yaml:"containerPorts,omitempty" mapstructure:"containerPorts,omitempty"`

	// ContainerSecurityContext corresponds to the JSON schema field
	// "containerSecurityContext".
	ContainerSecurityContext *UDRContainerSecurityContext `json:"containerSecurityContext,omitempty" yaml:"containerSecurityContext,omitempty" mapstructure:"containerSecurityContext,omitempty"`
	...
	Global *UDRGlobal `json:"global,omitempty" yaml:"global,omitempty" mapstructure:"global,omitempty"`
	...
	Image *UDRImage `json:"image,omitempty" yaml:"image,omitempty" mapstructure:"image,omitempty"`
	...
	LivenessProbe *UDRLivenessProbe `json:"livenessProbe,omitempty" yaml:"livenessProbe,omitempty" mapstructure:"livenessProbe,omitempty"`

	// Mongodb corresponds to the JSON schema field "mongodb".
	Mongodb *UDRMongodb `json:"mongodb,omitempty" yaml:"mongodb,omitempty" mapstructure:"mongodb,omitempty"`
	...
	NodeAffinityPreset *UDRNodeAffinityPreset `json:"nodeAffinityPreset,omitempty" yaml:"nodeAffinityPreset,omitempty" mapstructure:"nodeAffinityPreset,omitempty"`
	...
	PodSecurityContext *UDRPodSecurityContext `json:"podSecurityContext,omitempty" yaml:"podSecurityContext,omitempty" mapstructure:"podSecurityContext,omitempty"`
	...
	ReadinessProbe *UDRReadinessProbe `json:"readinessProbe,omitempty" yaml:"readinessProbe,omitempty" mapstructure:"readinessProbe,omitempty"`
	...
	Resources *UDRResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
	...
	ServiceAccount *UDRServiceAccount `json:"serviceAccount,omitempty" yaml:"serviceAccount,omitempty" mapstructure:"serviceAccount,omitempty"`

	// Services corresponds to the JSON schema field "services".
	Services *UDRServices `json:"services,omitempty" yaml:"services,omitempty" mapstructure:"services,omitempty"`
	...
	StartupProbe *UDRStartupProbe `json:"startupProbe,omitempty" yaml:"startupProbe,omitempty" mapstructure:"startupProbe,omitempty"`
	...
	UpdateStrategy *UDRUpdateStrategy `json:"updateStrategy,omitempty" yaml:"updateStrategy,omitempty" mapstructure:"updateStrategy,omitempty"`
}
...
type UDRConfig struct {
	...
	Sbi *UDRConfigSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type UDRConfigSbi struct {
	// Client corresponds to the JSON schema field "client".
	Client *UDRConfigSbiClient `json:"client,omitempty" yaml:"client,omitempty" mapstructure:"client,omitempty"`
...
type UDRConfigSbiClient struct {
	// Nrf corresponds to the JSON schema field "nrf".
	Nrf *UDRConfigSbiClientNrf `json:"nrf,omitempty" yaml:"nrf,omitempty" mapstructure:"nrf,omitempty"`

	// Scp corresponds to the JSON schema field "scp".
	Scp *UDRConfigSbiClientScp `json:"scp,omitempty" yaml:"scp,omitempty" mapstructure:"scp,omitempty"`
}

type UDRConfigSbiClientNrf struct {
...
type UDRConfigSbiClientScp struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
func (j *UDRConfigSbi) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	type Plain UDRConfigSbi
	var plain Plain
	...
	*j = UDRConfigSbi(plain)
	return nil
}

// UnmarshalYAML implements yaml.Unmarshaler.
func (j *UDRConfigSbi) UnmarshalYAML(value *yaml.Node) error {
	var raw map[string]interface{}
...
type UDRMongodb struct {
	// Auth corresponds to the JSON schema field "auth".
	Auth *UDRMongodbAuth `json:"auth,omitempty" yaml:"auth,omitempty" mapstructure:"auth,omitempty"`

	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
}

type UDRMongodbAuth struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
}

type UDRNodeAffinityPreset struct {
...
type UDRPodSecurityContext struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type UDRServices struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *UDRServicesSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type UDRServicesSbi struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	NodePorts *UDRServicesSbiNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *UDRServicesSbiPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type UDRServicesSbiNodePorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *string `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type UDRServicesSbiPorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *int `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type UDRStartupProbe struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
