...
func (b *BasicStrategy) adjustBandwidth(play *model.Deploy, metrics UsedMetrics, sla model.SLA) error {
	// 获取当前配置带宽
...
func (b *BasicStrategy) adjustAvailability(play *model.Deploy, metrics UsedMetrics, sla model.SLA) error {
