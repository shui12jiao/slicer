...
type AUSF struct {
	...
	Config *AUSFConfig `json:"config,omitempty" yaml:"config,omitempty" mapstructure:"config,omitempty"`

	// ContainerPorts corresponds to the JSON schema field "containerPorts".
	ContainerPorts *AUSFContainerPorts `json:"containerPorts,omitempty" yaml:"containerPorts,omitempty" mapstructure:"containerPorts,omitempty"`

	// ContainerSecurityContext corresponds to the JSON schema field
	// "containerSecurityContext".
	ContainerSecurityContext *AUSFContainerSecurityContext `json:"containerSecurityContext,omitempty" yaml:"containerSecurityContext,omitempty" mapstructure:"containerSecurityContext,omitempty"`
	...
	Global *AUSFGlobal `json:"global,omitempty" yaml:"global,omitempty" mapstructure:"global,omitempty"`
	...
	Image *AUSFImage `json:"image,omitempty" yaml:"image,omitempty" mapstructure:"image,omitempty"`
	...
	LivenessProbe *AUSFLivenessProbe `json:"livenessProbe,omitempty" yaml:"livenessProbe,omitempty" mapstructure:"livenessProbe,omitempty"`
	...
	NodeAffinityPreset *AUSFNodeAffinityPreset `json:"nodeAffinityPreset,omitempty" yaml:"nodeAffinityPreset,omitempty" mapstructure:"nodeAffinityPreset,omitempty"`
	...
	PodSecurityContext *AUSFPodSecurityContext `json:"podSecurityContext,omitempty" yaml:"podSecurityContext,omitempty" mapstructure:"podSecurityContext,omitempty"`
	...
	ReadinessProbe *AUSFReadinessProbe `json:"readinessProbe,omitempty" yaml:"readinessProbe,omitempty" mapstructure:"readinessProbe,omitempty"`
	...
	Resources *AUSFResources `json:"resources,omitempty" yaml:"resources,omitempty" mapstructure:"resources,omitempty"`
	...
	ServiceAccount *AUSFServiceAccount `json:"serviceAccount,omitempty" yaml:"serviceAccount,omitempty" mapstructure:"serviceAccount,omitempty"`

	// Services corresponds to the JSON schema field "services".
	Services *AUSFServices `json:"services,omitempty" yaml:"services,omitempty" mapstructure:"services,omitempty"`
	...
	StartupProbe *AUSFStartupProbe `json:"startupProbe,omitempty" yaml:"startupProbe,omitempty" mapstructure:"startupProbe,omitempty"`
	...
	UpdateStrategy *AUSFUpdateStrategy `json:"updateStrategy,omitempty" yaml:"updateStrategy,omitempty" mapstructure:"updateStrategy,omitempty"`
}
...
type AUSFConfig struct {
	...
	Sbi *AUSFConfigSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type AUSFConfigSbi struct {
	// Client corresponds to the JSON schema field "client".
	Client *AUSFConfigSbiClient `json:"client,omitempty" yaml:"client,omitempty" mapstructure:"client,omitempty"`
...
type AUSFConfigSbiClient struct {
	// Nrf corresponds to the JSON schema field "nrf".
	Nrf *AUSFConfigSbiClientNrf `json:"nrf,omitempty" yaml:"nrf,omitempty" mapstructure:"nrf,omitempty"`

	// Scp corresponds to the JSON schema field "scp".
	Scp *AUSFConfigSbiClientScp `json:"scp,omitempty" yaml:"scp,omitempty" mapstructure:"scp,omitempty"`
}

type AUSFConfigSbiClientNrf struct {
...
type AUSFConfigSbiClientScp struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
func (j *AUSFConfigSbi) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	type Plain AUSFConfigSbi
	var plain Plain
	...
	*j = AUSFConfigSbi(plain)
	return nil
}

// UnmarshalYAML implements yaml.Unmarshaler.
func (j *AUSFConfigSbi) UnmarshalYAML(value *yaml.Node) error {
	var raw map[string]interface{}
...
type AUSFNodeAffinityPreset struct {
...
type AUSFPodSecurityContext struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type AUSFReadinessProbe struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type AUSFServiceAccount struct {
...
type AUSFServices struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *AUSFServicesSbi `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type AUSFServicesSbi struct {
	// Annotations corresponds to the JSON schema field "annotations".
	Annotations map[string]interface{} `json:"annotations,omitempty" yaml:"annotations,omitempty" mapstructure:"annotations,omitempty"`
	...
	NodePorts *AUSFServicesSbiNodePorts `json:"nodePorts,omitempty" yaml:"nodePorts,omitempty" mapstructure:"nodePorts,omitempty"`

	// Ports corresponds to the JSON schema field "ports".
	Ports *AUSFServicesSbiPorts `json:"ports,omitempty" yaml:"ports,omitempty" mapstructure:"ports,omitempty"`
...
type AUSFServicesSbiNodePorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *string `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type AUSFServicesSbiPorts struct {
	// Sbi corresponds to the JSON schema field "sbi".
	Sbi *int `json:"sbi,omitempty" yaml:"sbi,omitempty" mapstructure:"sbi,omitempty"`
}

type AUSFStartupProbe struct {
	// Enabled corresponds to the JSON schema field "enabled".
	Enabled *bool `json:"enabled,omitempty" yaml:"enabled,omitempty" mapstructure:"enabled,omitempty"`
...
type AUSFUpdateStrategy struct {
	// Type corresponds to the JSON schema field "type".
	Type *string `json:"type,omitempty" yaml:"type,omitempty" mapstructure:"type,omitempty"`
}
